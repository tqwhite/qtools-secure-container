...
const moduleFunction = function({ nodeRsaKey, forceDitto, secureContainerWorkingDir }) {
	//===================================================================================
	// UNWRAP DATA

	const decryptData = require('./decryptData')({ nodeRsaKey, forceDitto, }).decryptData;
...
// 			);
		...
		taskList.push((args, next) => {
			const { nodeRsaKey, forceDitto, fileReadResult, symmetricKeyEncrypted } = args;
		...
		const initialData = { inFilePath, outputDirPath, outputName, nodeRsaKey, forceDitto};
