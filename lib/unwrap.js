...
const moduleFunction = function({ nodeRsaKey, forceTar, secureContainerWorkingDir }) {
	//===================================================================================
	// UNWRAP DATA

	const decryptData = require('./decryptData')({ nodeRsaKey, forceTar, }).decryptData;
...
// 			);
		...
		taskList.push((args, next) => {
			const { nodeRsaKey, forceTar, fileReadResult, symmetricKeyEncrypted } = args;
		...
		const initialData = { inFilePath, outputDirPath, outputName, nodeRsaKey, forceTar};
