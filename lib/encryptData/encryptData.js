...
const moduleFunction = function({ nodeRsaKey }) {
	...
	const encryptData = (args, callback) => {
		console.log(
			`\n=-=============   encryptData  ========================= [encryptData.js.moduleFunction]\n`
		);

		const { outputName, inFileData, inFilePath, nodeRsaKey, secureContainerWorkingDir } = args;
...
console.log(`zipOutputFilePath=${zipOutputFilePath} [${moduleName}]`);
console.log(`secureContainerPath=${secureContainerPath} [${moduleName}]`);
...
console.log(`\n=-=============  X: fs.rmSync  workingSourceFilePath [${moduleName}]  ========================= [encryptData.js.moduleFunction]\n`);
...
console.log(`\n=-=============  X: fs.rmSync  zipOutputFilePath [${moduleName}]  ========================= [encryptData.js.moduleFunction]\n`);
