...
const moduleFunction = function({ nodeRsaKey, forceDitto }) {
	// ===================================================================================
	//WRAP DATA TO DATA
	...
	const encryptData = (args, callback) => {
		...
		taskList.push((args, next) => {
			const { nodeRsaKey, forceDitto, sourceFileInBase64 } = args;
		...
		const initialData = { outputName, inFilePath, nodeRsaKey, forceDitto, };
